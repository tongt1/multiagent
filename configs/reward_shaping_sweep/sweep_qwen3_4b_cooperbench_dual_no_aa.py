"""Qwen3-4B CooperBench DUAL-MODEL: freeze_verifier, no advantage alignment.

Dual GRPO with role-masked gradients. Only solver tokens receive gradients.
Verifier/judge roles frozen. Uses DAPO defaults (asymmetric clip, no KL, no std norm).
"""
...
class Qwen3_4bCooperBenchDualNoAA(sweep_base.Sweep):
...
if __name__ == "__main__":
    sweep.cli.run_sweep_with_flags(Qwen3_4bCooperBenchDualNoAA(), debugging_artefacts=[__file__])
