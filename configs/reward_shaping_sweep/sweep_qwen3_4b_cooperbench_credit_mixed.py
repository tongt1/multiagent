"""Qwen3-4B CooperBench: Reward mixing credit assignment.

r' = alpha*G + (1-alpha)*local — linear blend of global and per-role rewards.
alpha=0.5 for equal weight.
"""
...
class Qwen3_4bCreditMixed(sweep_base.Sweep):
        ...
        patch_run_config=dict(
            ...
            minizord=flink_zord.FlinkZordConfig(
                ...
                actor_outputs_streamers=[DebateMetricStreamerConfig(n_rollouts_per_prompt=_G,
                    reward_shaping_strategy="reward_mixing", reward_shaping_params={"alpha": 0.5})],
...
if __name__ == "__main__":
    sweep.cli.run_sweep_with_flags(Qwen3_4bCreditMixed(), debugging_artefacts=[__file__])
