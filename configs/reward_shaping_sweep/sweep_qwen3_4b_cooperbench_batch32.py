"""Qwen3-4B CooperBench: Large batch size (32).

Same as main DAPO config but with batch_size=32 (2x default).
Tests whether larger batches improve gradient estimation.
"""
...
_TRAIN_BATCH_SIZE = 32  # 2x default
_EVAL_BATCH_SIZE = 4
...
class Qwen3_4bCooperBenchBatch32(sweep_base.Sweep):
...
if __name__ == "__main__":
    sweep.cli.run_sweep_with_flags(Qwen3_4bCooperBenchBatch32(), debugging_artefacts=[__file__])
