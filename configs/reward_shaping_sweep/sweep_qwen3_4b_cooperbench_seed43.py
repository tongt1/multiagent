"""Qwen3-4B CooperBench Seed 43: Multi-seed training run for variance measurement.
...
Usage:
    PYTHONPATH=/mnt/data/terry/repos/post_training/src:/mnt/data/terry/home/reward-training \\
        ...
        configs/reward_shaping_sweep/sweep_qwen3_4b_cooperbench_seed43.py --submit start
"""
...
class Qwen3_4bCooperBenchSeed43(sweep_base.Sweep):
    settings: sweep.SweepSettings = sweep.SweepSettings(
        sweep_output_path="${HOME}/sweep_jobs/qwen3_4b_cooperbench_seed43/",
    ...
    fax: sweep.FaxConfig = sweep_base.PostTraining(
        ...
        ckpt_path=CKPT_PATH,
        output_dir="s3://us-east-01a/30d/post-training/${USER}/multiagent-debate-rl/qwen3-4b-cooperbench-seed43/${SWEEP_NAME}/${TRIAL_IDX}",
...
if __name__ == "__main__":
    sweep.cli.run_sweep_with_flags(Qwen3_4bCooperBenchSeed43(), debugging_artefacts=[__file__])
