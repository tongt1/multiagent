"""Qwen3-4B CooperBench: COMA counterfactual credit assignment.

A_i = Q(s,a) - baseline_i — counterfactual multi-agent baseline.
With 1 gen/prompt, falls back to batch-level mean baseline.
"""
        ...
        patch_run_config=dict(
            ...
            minizord=flink_zord.FlinkZordConfig(
                ...
                actor_outputs_streamers=[DebateMetricStreamerConfig(n_rollouts_per_prompt=_G,
                    reward_shaping_strategy="coma_advantage", reward_shaping_params={"n_rollouts_per_prompt": _G})],
...
if __name__ == "__main__":
    sweep.cli.run_sweep_with_flags(Qwen3_4bCreditComa(), debugging_artefacts=[__file__])
