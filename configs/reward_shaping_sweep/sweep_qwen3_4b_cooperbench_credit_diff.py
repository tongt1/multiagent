"""Qwen3-4B CooperBench: Difference rewards credit assignment.

D_i = G(z) - G(z_{-i}) — each agent's marginal contribution.
Dual-model with frozen verifier.
"""
...
class Qwen3_4bCreditDiff(sweep_base.Sweep):
...
if __name__ == "__main__":
    sweep.cli.run_sweep_with_flags(Qwen3_4bCreditDiff(), debugging_artefacts=[__file__])
